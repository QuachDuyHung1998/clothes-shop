    ...
    <section id="dashboard-ecommerce">
        ...
        <div class="col-xl-4 col-md-6 col-12">
            ...
            <div class="card-body">
                ...
                <img src="{{ asset('app-assets/images/badge.svg') }}" class="congratulation-medal" alt="Medal Pic" />
            </div>
            </div>
        </div>
        <!--/ Medal Card -->
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="avatar-content">
                                <img src="{{ asset('app-assets/images/toolbox.svg') }}" alt="Toolbar svg" />
                            </div>
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar rounded">
                            <div class="avatar-content">
                                <img src="{{ asset('app-assets/images/parachute.svg') }}" alt="Parachute svg" />
                            </div>
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar rounded">
                            <div class="avatar-content">
                                <img src="{{ asset('app-assets/images/brush.svg') }}" alt="Brush svg" />
                            </div>
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar rounded">
                            <div class="avatar-content">
                                <img src="{{ asset('app-assets/images/star.svg') }}" alt="Star svg" />
                            </div>
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar rounded">
                            <div class="avatar-content">
                                <img src="{{ asset('app-assets/images/book.svg') }}" alt="Book svg" />
                            </div>
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar rounded">
                            <div class="avatar-content">
                                <img src="{{ asset('app-assets/images/rocket.svg') }}" alt="Rocket svg" />
                            </div>
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar rounded">
                            <div class="avatar-content">
                                <img src="{{ asset('app-assets/images/speaker.svg') }}" alt="Speaker svg" />
                            </div>
                            </div>
                            <div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
            ...
            <div class="meetup-img-wrapper rounded-top text-center">
                <img src="{{ asset('app-assets/images/email.svg') }}" alt="Meeting Pic" height="170" />
            </div>
            <div class="card-body">
                ...
                >
                    <img src="{{ asset('app-assets/images/avatar-s-9.jpg') }}" alt="Avatar" width="33" height="33" />
                </div>
                <div
                    data-toggle="tooltip"
                    data-popup="tooltip-custom"
                    ...
                    class="avatar pull-up"
                >
                    <img src="{{ asset('app-assets/images/avatar-s-6.jpg') }}" alt="Avatar" width="33" height="33" />
                </div>
                <div
                    data-toggle="tooltip"
                    data-popup="tooltip-custom"
                    ...
                    class="avatar pull-up"
                >
                    <img src="{{ asset('app-assets/images/avatar-s-8.jpg') }}" alt="Avatar" width="33" height="33" />
                </div>
                <div
                    data-toggle="tooltip"
                    data-popup="tooltip-custom"
                ...
                >
                    <img
                    src="{{ asset('app-assets/images/avatar-s-20.jpg') }}"
                    alt="Avatar"
                    width="33"
                    height="33"
                    />
        ...
        <div class="col-lg-4 col-md-6 col-12">
            ...
            <div class="card-body">
                ...
                <div class="media">
                    <img
                    src="{{ asset('app-assets/images/google-chrome.png') }}"
                    class="rounded mr-1"
                    height="30"
                    alt="Google Chrome"
                    />
                ...
                <div class="media">
                    <img
                    src="{{ asset('app-assets/images/mozila-firefox.png') }}"
                    class="rounded mr-1"
                    height="30"
                    alt="Mozila Firefox"
                    />
                ...
                <div class="media">
                    <img
                    src="{{ asset('app-assets/images/apple-safari.png') }}"
                    class="rounded mr-1"
                    height="30"
                    alt="Apple Safari"
                    />
                ...
                <div class="media">
                    <img
                    src="{{ asset('app-assets/images/internet-explorer.png') }}"
                    class="rounded mr-1"
                    height="30"
                ...
                <div class="browser-states">
                <div class="media">
                    <img src="{{ asset('app-assets/images/opera.png') }}" class="rounded mr-1" height="30" alt="Opera Mini" />
